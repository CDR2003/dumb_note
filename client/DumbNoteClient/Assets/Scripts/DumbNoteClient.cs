...
namespace DumbNote
{
	...
	public abstract class DumbNoteServerConnectorBase : Client
	{
		/// <summary>
		/// 回复登录请求
		/// </summary>
		...
		protected abstract void UpdateNote( string note );

		public DumbNoteServerConnectorBase()
		{
		}
		...
		/// </summary>
		/// <param name="note">笔记内容</param>
		public void CommitNote( string note )
		{
			var packet = new OutPacket( (int)OutMessage.CommitNote );
